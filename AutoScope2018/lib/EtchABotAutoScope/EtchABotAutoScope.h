/*
 * EtchABotAutoScope.h - Library for controlling the EtchABot.
 ...
 */
#ifndef EtchABotAutoScope_h
#define EtchABotAutoScope_h
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RN/DK:For AutoScope 2018 (direct gear drive) I'm testing different backlashes
#define DEFAULT_HORZ_BACKLASH 40 // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RN/DK:for scope testing, changed from default of 120
#define DEFAULT_VERT_BACKLASH 70 // %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RN/DK:for scope testing, changed from default of 120
...
class EtchABotAutoScope
{
  private:
	...
	int _currentX = 1000, _currentY = 1000;  //Assume we're starting at the upper left corner always
  ...
  public:
    EtchABotAutoScope(int type, int h1, int h2, int h3, int h4, int v1, int v2, int v3, int v4);
	EtchABotAutoScope(int type);		
